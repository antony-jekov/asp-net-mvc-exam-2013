...
namespace MVCExam.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("UserName", "Username must be at least 6 letters long.");
            }

            if (model.UserName.Length > 16)
            {
                ModelState.AddModelError("UserName", "Username must not be more than 16 letters long.");
            }
